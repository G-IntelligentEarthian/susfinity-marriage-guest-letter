...
export const SubmissionPreview: React.FC<SubmissionPreviewProps> = ({
  ...
  const saveEdit = () => {
    ...
    if (trimmed.length < 8) {
      alert('Wishes must be at least 8 characters long.');
      return;
    }
            ...
            {isEditing ? (
              ...
              <div className="flex flex-col gap-2">
                <textarea
                  ...
                  placeholder={
                    isHandwritten
                      ? "Keyboard writing replaces your drawing. Type wishes..."
                      : "Refine your heart-felt note here..."
                  }
                  maxLength={600}
        ...
        {photoDataUrl && (
          <div className="relative group rounded-2xl overflow-hidden aspect-4/3 border border-[#cfbba0] shadow-md bg-neutral-900">
            ...
            <div className="absolute bottom-3 left-4 text-white text-xs font-sans tracking-wide font-medium flex items-center gap-2">
              ...
              <span>Portrait bound to letter successfully</span>
            </div>
            {onBackToCamera && (
              <button
